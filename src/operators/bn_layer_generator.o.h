#ifndef HALIDE__bn_layer_generator_o_h
#define HALIDE__bn_layer_generator_o_h
#include <stdint.h>
...
int bn_tiramisu(struct halide_buffer_t *_input_buf_buffer, struct halide_buffer_t *_parameters_buf_buffer, struct halide_buffer_t *_sum_buff_buffer, struct halide_buffer_t *_sumSquared_buff_buffer, struct halide_buffer_t *_output_buf_buffer) HALIDE_FUNCTION_ATTRS;
int bn_tiramisu_old_buffer_t(struct buffer_t *_input_buf, struct buffer_t *_parameters_buf, struct buffer_t *_sum_buff, struct buffer_t *_sumSquared_buff, struct buffer_t *_output_buf) HALIDE_FUNCTION_ATTRS;
