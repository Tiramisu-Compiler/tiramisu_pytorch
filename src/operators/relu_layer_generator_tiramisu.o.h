...
int relu_tiramisu(struct halide_buffer_t *_input_buff_buffer, struct halide_buffer_t *_parameters_buff_buffer, struct halide_buffer_t *_output_buff_buffer) HALIDE_FUNCTION_ATTRS;
int relu_tiramisu_old_buffer_t(struct buffer_t *_input_buff, struct buffer_t *_parameters_buff, struct buffer_t *_output_buff) HALIDE_FUNCTION_ATTRS;
