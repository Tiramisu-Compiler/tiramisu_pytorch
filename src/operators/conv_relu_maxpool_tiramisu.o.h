#ifndef HALIDE__conv_relu_maxpool_tiramisu_o_h
#define HALIDE__conv_relu_maxpool_tiramisu_o_h
#include <stdint.h>
...
int conv_relu_maxpool_block(struct halide_buffer_t *_c_input_b0_buffer, struct halide_buffer_t *_conv_filter_b1_buffer, struct halide_buffer_t *_conv_bias_b2_buffer, struct halide_buffer_t *_output_buf_buffer) HALIDE_FUNCTION_ATTRS;
int conv_relu_maxpool_block_old_buffer_t(struct buffer_t *_c_input_b0, struct buffer_t *_conv_filter_b1, struct buffer_t *_conv_bias_b2, struct buffer_t *_output_buf) HALIDE_FUNCTION_ATTRS;
