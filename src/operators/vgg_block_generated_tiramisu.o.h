#ifndef HALIDE__generated_vgg_block_o_h
#define HALIDE__generated_vgg_block_o_h
#include <stdint.h>
...
int vgg_block(struct halide_buffer_t *_c_input_b0_buffer, struct halide_buffer_t *_filter1_b2_buffer, struct halide_buffer_t *_bias1_b1_buffer, struct halide_buffer_t *_filter2_b4_buffer, struct halide_buffer_t *_bias2_b3_buffer, struct halide_buffer_t *_conv1_buf_buffer, struct halide_buffer_t *_maxpool_buf_buffer) HALIDE_FUNCTION_ATTRS;
int vgg_block_old_buffer_t(struct buffer_t *_c_input_b0, struct buffer_t *_filter1_b2, struct buffer_t *_bias1_b1, struct buffer_t *_filter2_b4, struct buffer_t *_bias2_b3, struct buffer_t *_conv1_buf, struct buffer_t *_maxpool_buf) HALIDE_FUNCTION_ATTRS;
