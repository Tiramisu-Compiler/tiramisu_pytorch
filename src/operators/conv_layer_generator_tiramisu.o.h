#ifndef HALIDE__relu_layer_generator_tiramisu_o_h
#define HALIDE__relu_layer_generator_tiramisu_o_h
#include <stdint.h>
...
int conv_tiramisu(struct halide_buffer_t *_input_buff_buffer, struct halide_buffer_t *_parameters_buff_buffer, struct halide_buffer_t *_output_buff_buffer) HALIDE_FUNCTION_ATTRS;
int conv_tiramisu_old_buffer_t(struct buffer_t *_input_buff, struct buffer_t *_parameters_buff, struct buffer_t *_output_buff) HALIDE_FUNCTION_ATTRS;
